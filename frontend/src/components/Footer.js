                    ...
                    <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                      <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div className="widget">
                          <a href="#!">
                            <img src="/RapidQ-Phone.webp" alt="RapidQ" height="100" />
                          </a>
                        </div>
                      </div>
                      <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        ...
                        <div className="widget">
                          ...
                          {user ? (
                            ...
                            <p className="text-danger">
                              Please <Link to="/signin" className="text-primary">Sign In</Link> to submit a query.
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="col-xs-12 col-md-5 order-0 order-md-1">
                        <div className="social-media-wrapper">
                          <ul className="list-unstyled m-0 p-0 d-flex justify-content-center justify-content-md-end">
                            ...
                            <li className="me-0">
                              <a href="https://www.instagram.com/rapidq.in" target='blank' className="link-dark link-opacity-75-hover">
