      ...
      <section className="about-content">
        <div className='ourStory'>
          <div style={{padding:"10px", alignContent:"center", textAlign:"center"}}>
            ...
            Today, we are proud to serve the vibrant community at Chandigarh University, where QuickQ has become a trusted partner in simplifying food ordering and enhancing the dining experience.
            </p>
          </div>
          <div>
        ...
        <div className='whatWeDo'>
          ...
          <div style={{padding:"10px", alignContent:"center", textAlign:"center"}}>
            ...
            <p>
            QuickQ is a mobile and web application designed to simplify and streamline food ordering for both customers and vendors. 
            ...
            By bridging the gap between vendors and customers, QuickQ makes the entire food ordering process smoother, faster, and more efficient.
            </p>
          </div>
        </div>
        ...
        <div className='ourMission'>
          <span className='ourMission-1' style={{padding:"10px", alignContent:"center", textAlign:"center"}}>
            <h2>Our Mission</h2>
            <p>
            At QuickQ, our mission is to revolutionize the food ordering experience by providing unmatched convenience, speed, and transparency. 
